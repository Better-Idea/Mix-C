...
namespace mixc{
    ...
    template<class item>
    inline uxx index_of_last_miss(cxx<item> self, item * value, uxx count){
    ...
    inline uxx index_of_last_miss(cxx<item> self, item value, args const & ... list){
        implicit<item> group[] = { value, list... };
        return index_of_last_miss(self, (item *)group, 1 + sizeof...(args));
    }
}
