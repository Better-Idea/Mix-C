...
#define xpack_lang_wxx_is_lower_hex
    ...
    #pragma push_macro("xusing_lang_wxx")
        ...
        #undef  xuser
        #define xuser mixc::lang_wxx_is_lower_hex
...
namespace xuser::com::lang_wxx_is_lower_hex{
    namespace inc { using namespace mixc::lang_wxx_is_lower_hex::inc; }

    template<class final, class type>
    struct wxx : xusing_lang_wxx::wxx<final, type> {
        using xusing_lang_wxx::wxx<final, type>::wxx;
        using the_t = mixc::lang_wxx_is_lower_hex::core<type>;
...
#undef  xusing_lang_wxx
#define xusing_lang_wxx xuser::com::lang_wxx_is_lower_hex
