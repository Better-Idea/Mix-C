...
#ifndef xpack_lang_wxx_is_digtal
#define xpack_lang_wxx_is_digtal
    #pragma push_macro("xuser")
    #pragma push_macro("xusing_lang_wxx")
        #undef  xusing_lang_wxx
        #undef  xuser
        #define xuser mixc::lang_wxx_is_digtal
        #include"define/base_type.hpp"
        #include"lang/wxx.hpp"
    #pragma pop_macro("xusing_lang_wxx")
    #pragma pop_macro("xuser")

    namespace mixc::lang_wxx_is_digtal{
        template<class type>
...
namespace xuser::com::lang_wxx_is_digtal{
    ...
    struct wxx : xusing_lang_wxx::wxx<final, type> {
        ...
        final & is_digtal(bool * result) const {
            result[0] = the.is_digtal();
            return thex;
        }
    };
}
