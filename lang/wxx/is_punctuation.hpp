...
namespace mixc::lang_wxx_is_punctuation{
    ...
    struct core : inc::wxx<type>{
        ...
        bool is_punctuation() const {
            ...
            auto seq = inc::seqptr<u16>{lut}.subseq(co{0, end});
