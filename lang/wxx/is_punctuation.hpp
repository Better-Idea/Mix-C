...
#ifndef xpack_lang_wxx_is_punctuation
#define xpack_lang_wxx_is_punctuation
    ...
    namespace mixc::lang_wxx_is_punctuation{
        ...
        struct core : inc::wxx<type>{
            ...
            auto is_punctuation() const {
                static_assert(sizeof(type) <= 2);
                auto end = sizeof(type) == 1 ? ascii_lut_size : -1;
                auto uns = inc::unsigned_type<type>(the);
                return inc::binary_search<u16>::match(lut.range(0, end), u16(uns)) != not_exist;
            }
        };
    }
#endif
...
#undef  xusing_lang_wxx
#define xusing_lang_wxx ::mixc::lang_wxx_is_punctuation::xuser
